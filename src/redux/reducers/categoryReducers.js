import { ADD_CATEGORY, GET_CATEGORIES, DELETE_CATEGORY, EDIT_CATEGORY } from '../actions/categoryActions';
...
function categoryReducer(state={categories: []}, action){
  ...
  case EDIT_CATEGORY:
    ...
    state.categories = state.categories.map(c => c.id === action.category.id ? action.category : c);
    return Object.assign({}, state);
  default: 
